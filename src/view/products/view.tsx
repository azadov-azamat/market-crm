...
import {decrementBasket, incrementBasket, setBasket, setDiscountBasket} from "../../redux/reducers/variable.ts";
                      ...
                      <div className="hidden w-4/12 h-full xl:hidden xl:flex-col gap-3 justify-center">
                          <div className="flex w-full items-center gap-3">
                              ...
                              <div className="">
                                  <Typography variant={"h2"}
                                              className={"font-bold text-base"}>
                                      {currentProduct !== null && currentAmount !== 0 ? ((currentProduct?.price - currentDiscount) * currentAmount) + " sum" : currentProduct?.price + " sum"}
                                  </Typography>
                              </div>
                          </div>
                          <div className="">
              ...
              <Card shadow color={"white"} className={"border w-full md:w-3/12"}>
                  <CardBody className={"flex flex-col"}>
                      ...
                      <div className="flex flex-col gap-2 mt-12">
                          <Button className={"w-full flex justify-center items-center gap-2"} disabled={currentProduct?.count === 0} color={"blue"}
                                  onClick={() => {
                                      increment()
