...
export default function Basket() {
    ...
    const {baskets, stores, debtor, mixedPay} = useAppSelector(state => state.variables)
            ...
            <div>
                ...
                <div className={"w-full h-[80vh] flex justify-center items-center"}>
                    <div className="flex flex-col items-center gap-3">
                        ...
                        <Button className={"normal-case"} onClick={() => navigate(`/seller/products/${getMgId()}`)}>Mahsulot tanlang</Button>
                    </div>
                </div>
            </div>
        )
