        ...
        <div className={"flex flex-col gap-2"}>
          ...
          <Card className='px-4 py-3 md:w-9/12 w-full relative'>
                ...
                <div className="flex">
                    ...
                    <Typography variant="small" className="text-base"> {sale?.saleMainPrice} sum</Typography>
                </div>

                <div className="flex">
                    <Typography variant="small" className="text-base font-bold">Sotilgan narxi: &nbsp;</Typography>
                    <Typography variant="small" className="text-base"> {sale?.saleSoldPrice} sum</Typography>
                </div>

                <div className="flex">
                     <Typography variant="small" className="text-base font-bold">Sotuv sanasi: &nbsp;</Typography>
                     <Typography variant="small" className="text-base"><DateFormatClockComponent currentDate={sale?.createdAt}/></Typography>
                </div>

                <div className="flex">
                    <Typography variant="small" className="text-base font-bold">Sotuvchi: &nbsp;</Typography>
                    <Typography variant="small" className="text-base"> {sale?.seller?.sellerName}</Typography>
                </div>
                </CardBody>
                {sale?.saleDebt && <div className="absolute text-xs px-2 bg-red-500 text-white rounded right-1 top-1">qarz-savdo</div>}
            </Card>
                                        ...
                                        return (
                                            <div className="flex relative" key={ip}>
                                                ...
                                                <div className="absolute right-0">
                                                    <FiExternalLink className="text-green-500 text-base cursor-pointer" onClick={()=> {
                                    ...
                                    sale?.payments?.map((pr, ip)=> {
                                        return (
                                            <div className="flex" key={ip}>
                                                ...
                                                <div className="w-7/12">{handleSwitchPayType(pr.paymentType)}</div>
                                            </div> 
                                        )
                                    })
                                }
            ...
            <Card className='px-4 py-3 md:w-9/12 w-full relative'>
                <CardBody className='p-0'>
                {
                            ...
                            <div className="text-base"><b className='ml-3'>F.I.O: &nbsp;</b> {sale?.client?.clientName}</div>
                            <div className="text-base"><b className='ml-3'>Telefon raqami: &nbsp;</b> {sale?.client?.clientPhone}</div>
                            <div className="text-base"><b className='ml-3'>Manzili: &nbsp;</b> {sale?.client?.clientAdress}</div>
                            <div className="text-base"><b className='ml-3'>To'lov sanasi: &nbsp;</b> <DateFormatComponent currentDate={sale?.client?.clientPaymentDate}/></div>
